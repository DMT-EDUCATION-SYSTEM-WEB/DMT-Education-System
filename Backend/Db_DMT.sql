...
-- Seed base roles (idempotent theo code)
INSERT INTO "roles" ("code","name","capabilities_json") VALUES
  ('admin','Quản trị viên','["manage_users","manage_courses","manage_system","view_reports"]'),
  ('teacher','Giáo viên','["manage_classes","grade_students","view_students","manage_materials","send_emails"]'),
  ('student','Học viên','["view_courses","submit_assignments","view_grades","access_materials"]'),
  ('ta','Trợ giảng','["assist_classes","view_students","manage_materials","send_emails"]'),
  ('staff','Nhân viên','["support_students","support_teachers","manage_materials"]')
...
CREATE TABLE "students" (
  ...
  "cohort" int,
  CHECK ("student_code" ~ '^stu[0-9]{2}[0-9]{2,}$')
);
